...
<form action="{{ route('suratkeluars.update', $suratkeluar->id) }}" method="post" enctype="multipart/form-data">
  ...
  <div class="row mt-3">
      <div class="col">
        ...
        <input type="date" name="tglkeluar" class="form-control @if($errors->has('tglkeluar')) is-invalid @endif" placeholder="Masukkan Tgl. Masuk" value="{{$suratkeluar->tgl_masuk}}">
  ...
  <div class="row mt-3">
      <div class="col">
        ...
        <input type="text" name="tujuan" class="form-control @if($errors->has('tujuan')) is-invalid @endif" placeholder="Masukkan tujuan Surat" value="{{$suratkeluar->tujuan}}">
